...
class aropengl : public aropengl_base {
public:
aropengl() {}
...
bool create(uintptr_t parent, uintptr_t* window, uint32_t flags) { return aropengl_base::create(parent, window, flags, internalGetSymNames(), internalGetSymDest()); }
bool create(widget_viewport* port, uint32_t flags) { return aropengl_base::create(port, flags, internalGetSymNames(), internalGetSymDest()); }
...
funcptr* internalGetSymDest() { return (funcptr*)&this->Accum; }
